...
# Installing proving-it-works on Factory Droid / Grok / Copilot (marketplace descriptor)
...
```
droid plugin marketplace add https://github.com/prime-radiant-inc/proving-it-works
droid plugin install proving-it-works@proving-it-works
```
...
```
copilot plugin marketplace add https://github.com/prime-radiant-inc/proving-it-works
copilot plugin install proving-it-works@proving-it-works
```

On Grok:

```
grok plugin install https://github.com/prime-radiant-inc/proving-it-works --trust
```
