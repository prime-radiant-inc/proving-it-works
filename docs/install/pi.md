...
# Installing proving-it-works on Pi
...
- `.pi/extensions/proving-it-works.ts`, the Pi extension module that registers the plugin's skills directory

## Installing

```
pi install git:github.com/prime-radiant-inc/proving-it-works
```
